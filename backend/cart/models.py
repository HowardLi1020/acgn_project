...
class PaymentTransactions(models.Model):
    ...
    payment_method = models.CharField(max_length=50, blank=True, null=True)  # ✅ ECPay 回傳
    payment_status = models.CharField(max_length=9, choices=PAYMENT_STATUS_CHOICES)  # ✅ ECPay 回傳
    payment_date = models.DateTimeField(auto_now_add=True)
    payment_amount = models.DecimalField(max_digits=10, decimal_places=2)
    transaction_id = models.CharField(max_length=100, blank=True, null=True)  # ✅ ECPay 交易編號
