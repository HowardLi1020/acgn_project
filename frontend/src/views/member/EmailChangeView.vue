...
const handleSubmit = async (event) => {
    ...
    try {
        ...
        // 顯示成功信息
        errors.value.general = '如果新郵箱存在，您將會收到修改連接~!'
        isSuccess.value = true
    } catch (error) {
        errors.value.general = error.message || '發送"修改郵箱"驗證連結時發生錯誤，請稍後重試'
    ...
    <div class="form-section">
      <div class="form-content">
        <div class="text-center mb-4">	
          <RouterLink :to="{ name: 'EmailChange' }" class="app-logo">
        ...
        <div class="auth-intro mb-4 text-center">
          請於下方輸入您的註冊郵箱，與欲更換的新郵箱，<br>我們將發送驗證連接至您的新郵箱，以便您快速修改郵箱。<br>Enter your original email address and the new email address below. We'll email you a link to a page where you can easily to change your email address.
        </div>
        ...
        <div class="auth-form-container text-left">
          ...
          <form class="auth-form resetpass-form" @submit="handleSubmit">
            ...
            <div class="email mb-3">
              <label class="sr-only" for="new-email">新郵箱</label>
              <input 
                id="new-email" 
